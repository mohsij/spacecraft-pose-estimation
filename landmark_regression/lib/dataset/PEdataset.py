...
class PEdataset(JointsDataset):
    def __init__(self, cfg, root, image_dir, image_set, is_train, transform=None, numpy_transform=None, multi_scale_target=False):
        super().__init__(cfg, root, image_set, is_train, transform, numpy_transform, multi_scale_target)
